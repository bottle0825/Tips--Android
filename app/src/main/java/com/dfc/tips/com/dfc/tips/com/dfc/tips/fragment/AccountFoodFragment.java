...
import static com.dfc.tips.com.dfc.tips.msg.Tips_note.accounts_other;
import static com.dfc.tips.com.dfc.tips.msg.Tips_note.consumption_day;
import static com.dfc.tips.com.dfc.tips.msg.Tips_note.consumption_food;
import static com.dfc.tips.com.dfc.tips.msg.Tips_note.consumption_month;
import static com.dfc.tips.com.dfc.tips.msg.Tips_note.consumption_other;

public class AccountFoodFragment extends Fragment implements View.OnClickListener{
    ...
    public static AccountFoodFragment newInstance(AccountFragment parentFragment) {

        Bundle args = new Bundle();
        mParentFragment=parentFragment;
        AccountFoodFragment fragment = new AccountFoodFragment();
    ...
    private void init(){
        add = (TextView) view.findViewById(R.id.accountbook_food_add);
        add.setOnClickListener(this);
        totalamount = (TextView) view.findViewById(R.id.accountbook_food_totalamount);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_account_food, container, false);
        init();
    ...
    public void update_consumption(){
        ...
        accounts_food = new ArrayList<Account>();
        ...
        for (int i=0;i<accounts.size();i++){
            ...
            if (s.equals(gettime().substring(5,7))){
                ...
                if (accounts.get(i).getType().equals("food")){
                    accounts_food.add(accounts.get(i));
                    consumption_food = consumption_food+accounts.get(i).getAmount();
                }
            }
        }
        totalamount.setText(consumption_food+"");
      //  ((AccountFragment)getParentFragment()).update_consumption();
    ...
    public void createList(){
        ...
        for (int i = accounts_food.size()-1; i >=0; i--) {
            Map<String, Object> listItem = new HashMap<String, Object>();
            listItem.put("time", accounts_food.get(i).getTime());
            listItem.put("amount", accounts_food.get(i).getAmount());
            listItem.put("message", accounts_food.get(i).getMessage());
        ...
        final SwipeMenuListView list = (SwipeMenuListView) view.findViewById(R.id.accountbook_foodlist);
        ...
        list.setOnMenuItemClickListener(new SwipeMenuListView.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(final int myposition, SwipeMenu menu, int index) {
                switch (index) {
                    case 0:
                        // open
                        myDB.deleteDB(context,"accountbook",accounts_food.get(accounts_food.size()-myposition-1).getTime().toString(),Login_username);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.accountbook_food_add:
